...
/**
 * <p>PagedCardLog complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="PagedCardLog"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="CardLogList" type="{http://ws.baroservice.com/}ArrayOfCardLog" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PagedCardLog", propOrder = {
    "currentPage",
    "maxIndex",
    "countPerPage",
    "maxPageNum",
...
public class PagedCardLog {
    ...
    protected ArrayOfCardLog cardLogList;
     ...
     *     
     */
    public ArrayOfCardLog getCardLogList() {
        return cardLogList;
    }
     ...
     *     
     */
    public void setCardLogList(ArrayOfCardLog value) {
