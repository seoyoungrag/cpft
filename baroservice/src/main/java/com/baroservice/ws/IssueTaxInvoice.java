 ...
 *         &lt;element name="NTSSendOption" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
...
@XmlRootElement(name = "IssueTaxInvoice")
public class IssueTaxInvoice {
     ...
     * 
     */
    public void setNTSSendOption(int value) {
        this.ntsSendOption = value;
    }

    /**
     * forceIssue 속성의 값을 가져옵니다.
     * 
     */
