 ...
 *         &lt;element name="ChargeCode" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetChargeUnitCost")
public class GetChargeUnitCost {
    ...
    /**
     * chargeCode 속성의 값을 설정합니다.
     * 
     */
    public void setChargeCode(int value) {
