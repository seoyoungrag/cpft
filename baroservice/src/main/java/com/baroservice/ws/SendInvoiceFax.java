 ...
 *         &lt;element name="FromFaxNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="ToFaxNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SendInvoiceFax")
public class SendInvoiceFax {
    ...
    @XmlElement(name = "FromFaxNumber")
    protected String fromFaxNumber;
    @XmlElement(name = "ToFaxNumber")
    protected String toFaxNumber;
     ...
     *     
     */
    public void setFromFaxNumber(String value) {
        this.fromFaxNumber = value;
    }

    /**
     * toFaxNumber 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
