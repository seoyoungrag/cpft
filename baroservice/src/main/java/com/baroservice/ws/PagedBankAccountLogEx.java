...
/**
 * <p>PagedBankAccountLogEx complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="PagedBankAccountLogEx"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="BankAccountLogList" type="{http://ws.baroservice.com/}ArrayOfBankAccountLogEx" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PagedBankAccountLogEx", propOrder = {
    "currentPage",
    "countPerPage",
    "maxIndex",
    "maxPageNum",
...
public class PagedBankAccountLogEx {
    ...
    protected ArrayOfBankAccountLogEx bankAccountLogList;
    ...
    /**
     * bankAccountLogList 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfBankAccountLogEx }
     *     
     */
    public ArrayOfBankAccountLogEx getBankAccountLogList() {
        return bankAccountLogList;
    }

    /**
     * bankAccountLogList 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfBankAccountLogEx }
     *     
     */
    public void setBankAccountLogList(ArrayOfBankAccountLogEx value) {
