 ...
 *         &lt;element name="ChargeDirection" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RegistTaxInvoiceReverseEX")
public class RegistTaxInvoiceReverseEX {
    ...
    @XmlElement(name = "ChargeDirection")
    protected int chargeDirection;
    ...
    /**
     * chargeDirection 속성의 값을 가져옵니다.
     * 
     */
    public int getChargeDirection() {
        return chargeDirection;
    }

    /**
     * chargeDirection 속성의 값을 설정합니다.
     * 
     */
    public void setChargeDirection(int value) {
        this.chargeDirection = value;
    }
