 ...
 *         &lt;element name="newManagerID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeCorpManager")
public class ChangeCorpManager {

    @XmlElement(name = "CERTKEY")
    protected String certkey;
    @XmlElement(name = "CorpNum")
    protected String corpNum;
    protected String newManagerID;
     ...
     *     
     */
    public void setNewManagerID(String value) {
        this.newManagerID = value;
    }
