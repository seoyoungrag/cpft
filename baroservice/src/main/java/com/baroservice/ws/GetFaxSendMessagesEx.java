 ...
 *         &lt;element name="SendKeyList" type="{http://ws.baroservice.com/}ArrayOfString" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetFaxSendMessagesEx")
public class GetFaxSendMessagesEx {

    @XmlElement(name = "CERTKEY")
    protected String certkey;
    @XmlElement(name = "CorpNum")
    protected String corpNum;
    @XmlElement(name = "SendKeyList")
    protected ArrayOfString sendKeyList;
     ...
     *     
     */
    public ArrayOfString getSendKeyList() {
        return sendKeyList;
    }

    /**
     * sendKeyList 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfString }
     *     
     */
    public void setSendKeyList(ArrayOfString value) {
        this.sendKeyList = value;
    }
