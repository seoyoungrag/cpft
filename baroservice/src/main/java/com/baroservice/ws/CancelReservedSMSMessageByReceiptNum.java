...
@XmlRootElement(name = "CancelReservedSMSMessageByReceiptNum")
public class CancelReservedSMSMessageByReceiptNum {

    @XmlElement(name = "CERTKEY")
    protected String certkey;
    @XmlElement(name = "CorpNum")
    protected String corpNum;
    @XmlElement(name = "ReceiptNum")
