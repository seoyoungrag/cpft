...
/**
 * <p>FaxMessageEx complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="FaxMessageEx"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="fileURLs" type="{http://ws.baroservice.com/}ArrayOfString" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "FaxMessageEx", propOrder = {
    "sendKey",
    "id",
    "sendFileName",
    "sendPageCount",
...
public class FaxMessageEx {
     ...
     *     
     */
    public void setFileURLs(ArrayOfString value) {
        this.fileURLs = value;
    }
