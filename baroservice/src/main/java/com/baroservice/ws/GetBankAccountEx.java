 ...
 *         &lt;element name="AvailOnly" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetBankAccountEx")
public class GetBankAccountEx {

    @XmlElement(name = "CERTKEY")
    protected String certkey;
    @XmlElement(name = "CorpNum")
    protected String corpNum;
    @XmlElement(name = "AvailOnly")
    protected int availOnly;
    ...
    /**
     * availOnly 속성의 값을 가져옵니다.
     * 
     */
    public int getAvailOnly() {
        return availOnly;
    }

    /**
     * availOnly 속성의 값을 설정합니다.
     * 
     */
    public void setAvailOnly(int value) {
        this.availOnly = value;
    }
