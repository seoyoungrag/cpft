...
/**
 * <p>PagedFaxMessages complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="PagedFaxMessages"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="MessageList" type="{http://ws.baroservice.com/}ArrayOfFaxMessage" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PagedFaxMessages", propOrder = {
    "currentPage",
    "maxIndex",
    "countPerPage",
    "maxPageNum",
...
public class PagedFaxMessages {
     ...
     *     
     */
    public void setMessageList(ArrayOfFaxMessage value) {
