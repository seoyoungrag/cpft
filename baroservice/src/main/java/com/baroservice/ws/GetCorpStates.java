 ...
 *         &lt;element name="CheckCorpNumList" type="{http://ws.baroservice.com/}ArrayOfString" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetCorpStates")
public class GetCorpStates {

    @XmlElement(name = "CERTKEY")
    protected String certkey;
    @XmlElement(name = "CorpNum")
    protected String corpNum;
    @XmlElement(name = "CheckCorpNumList")
    protected ArrayOfString checkCorpNumList;
     ...
     *     
     */
    public ArrayOfString getCheckCorpNumList() {
        return checkCorpNumList;
    }

    /**
     * checkCorpNumList 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfString }
     *     
     */
    public void setCheckCorpNumList(ArrayOfString value) {
        this.checkCorpNumList = value;
    }
