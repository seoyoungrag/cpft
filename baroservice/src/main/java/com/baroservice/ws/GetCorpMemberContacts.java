 ...
 *         &lt;element name="CheckCorpNum" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetCorpMemberContacts")
public class GetCorpMemberContacts {

    @XmlElement(name = "CERTKEY")
    protected String certkey;
    @XmlElement(name = "CorpNum")
    protected String corpNum;
    @XmlElement(name = "CheckCorpNum")
    protected String checkCorpNum;
     ...
     *     
     */
    public String getCheckCorpNum() {
        return checkCorpNum;
    }

    /**
     * checkCorpNum 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCheckCorpNum(String value) {
        this.checkCorpNum = value;
    }
