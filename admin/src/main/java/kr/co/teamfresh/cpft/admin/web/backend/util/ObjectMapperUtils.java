...
import kr.co.teamfresh.cpft.admin.web.backend.config.modelmap.mapper.TruckOwnerCommonInfoEnToDtoMap;
...
public class ObjectMapperUtils {
	...
	static {
		...
		modelMapper.addMappings(new TruckOwnerCommonInfoEnToDtoMap());
