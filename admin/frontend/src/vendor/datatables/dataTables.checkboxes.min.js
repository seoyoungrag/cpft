...
!(function (c) {
	...
	function x(e) {
		...
		(this.s = { dt: new f.Api(e), columns: [], data: [], dataDisabled: [], ignoreSelect: !1 }),
	...
	(x.prototype = {
		_constructor: function () {
			for (var e, t, c, s, o, l, a, n = this, d = n.s.dt, i = n.s.ctx, h = !1, u = !1, r = 0; r < i.aoColumns.length; r++) {
				i.aoColumns[r].checkboxes &&
					...
					"" === i.aoColumns[r].sClass
						? (t.className = "dt-checkboxes-cell")
						: (t.className = i.aoColumns[r].sClass + " dt-checkboxes-cell"),
					...
					i.aoColumns[r].checkboxes.selectAll &&
						...
						null !== i.aoColumns[r].checkboxes.selectAllRender &&
							...
							k.isFunction(i.aoColumns[r].checkboxes.selectAllRender)
								...
								: "string" == typeof i.aoColumns[r].checkboxes.selectAllRender &&
								  (s = i.aoColumns[r].checkboxes.selectAllRender),
			...
			h &&
				...
				k(b).on("click.dtCheckboxes", '.fixedHeader-floating thead th.dt-checkboxes-select-all input[type="checkbox"]', function (
					e
				) {
		...
		updateCheckbox: function (e, t, c) {
			...
			o.length &&
				...
				k.isFunction(s.aoColumns[t].checkboxes.selectCallback) && s.aoColumns[t].checkboxes.selectCallback(o, c));
		},
		...
		updateStateCheckboxes: function (e) {
			...
			t.cells("tr", o.s.columns, e).every(function (e, t) {
				...
				l.checkboxes.s.data[t].hasOwnProperty(c) &&
					(o.updateCheckbox(this, t, !0), l.aoColumns[t].checkboxes.selectRow && s && o.updateSelect(e, !0)),
		...
		updateSelectAll: function (c) {
			...
			x.aoColumns[c].checkboxes &&
				...
				x._fixedHeader &&
					...
					(s = k('.fixedHeader-floating .dt-checkboxes-select-all[data-col="' + c + '"] input[type="checkbox"]')),
				...
				(!i && h === n && u === d) ||
					...
					k.isFunction(x.aoColumns[c].checkboxes.selectAllCallback) &&
						x.aoColumns[c].checkboxes.selectAllCallback(s.closest("th").get(0), n, d)));
		},
						...
						(c = "row"),
							...
							l.append(
								k('<span class="select-item"/>').append(
									n.i18n("select." + c + "s", { _: "%d " + c + "s selected", 0: "", 1: "1 " + c + " selected" }, s)
								)
							);
					...
					function (e, t, c) {
						...
						e.aoColumns[c].checkboxes &&
							...
							e.aoColumns[c].checkboxes.selectRow &&
								e.checkboxes.s.data[c].hasOwnProperty(o) &&
