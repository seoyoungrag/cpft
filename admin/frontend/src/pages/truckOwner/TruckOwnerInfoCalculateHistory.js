...
function TruckOwnerInfoCalculateHistory(props) {
	useEffect(() => {
		...
		extraSearchTab.push(function (settings, data, dataInex) {
			let from = $("#fromDate").datepicker("getDate");
			let to = $("#toDate").datepicker("getDate");
			let carrierCalculateDate = new Date(data[4]);
			...
			<div className="card-header row">
				<div className="col-12 row mt-3">
					...
					<div className="form-group row col-4 d-flex justify-content-end m-auto p-auto">
						<input className="form-control datepicker col-3" id="fromDate" name="fromDate" type="text" placeholder="2020-01-01" />
						<label className="col-form-label ml-3 mr-3">~</label>
						<input className="form-control datepicker col-3" id="toDate" name="toDate" type="text" placeholder="2020-12-31" />
					</div>
				</div>
			</div>
