...
function TruckOwnerInfoCommon(props) {
    ...
    const { userName, ownerCode, phoneNumber, carrierSeq } = inputs;
                        ...
                        <div className="container-fluid">
                            <div className="page-header-content">
                                ...
                                <div className="page-header-subtitle">
                                    TruckOwnerInfoDetail 차주 정보 상세보기 페이지
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="card-body">
                                <div className="basicInfoArea" style={{ overflow: "hidden", marginBottom: "20px", height: "70px" }}>
                                    ...
                                    <div className="basicInfoArea" style={{ float: "left" }}>
                                        <span id="userName" style={{ fontSize: "25px", heigth: "70px", lineHeight: "70px", marginRight: "50px" }}>{userName}</span>
                                        <span style={{ fontSize: "15px", marginRight: "50px" }}>
                                            <b>연락처</b>&nbsp;&nbsp;
                                            <input type="text" id="phoneNumber" name="phoneNumber" onChange={handleChange} value={phoneNumber} style={{ width: "130px" }}/>
                                        </span>
                                        <span id="" style={{ fontSize: "15px", marginRight: "50px" }}><b>가입 상태</b>&nbsp;&nbsp;-</span>
                                        <span style={{ fontSize: "15px", marginRight: "50px" }}>
                                            <b>차주코드</b>&nbsp;&nbsp;
                                            <input type="text" id="ownerCode" name="ownerCode" onChange={handleChange} value={ownerCode} style={{ width: "130px" }} />
                                        </span>
                                    </div>
                                    <div className="modifyBtnArea" style={{ float: "right" }}>
                                        <button type="button" onClick={handleClick} id="basicInfoModifyBtn">수정</button>
                                    </div>
                                </div>
                                ...
                                <div className="card-body">
                                    <div className="tab-content">
                                        <div className="tab-pane col-12 active" id="personalInfo">
                                            <TruckOwnerInfoDetail userSeq={userSeq} carrierSeq={carrierSeq} />
                                        </div>
                                        <div className="tab-pane col-12" id="transferHistory">
                                            <TruckOwnerInfoTransferHistory userSeq={userSeq} carrierSeq={carrierSeq} />
                                        </div>
                                        <div className="tab-pane col-12" id="purchaseHistory">
                                            <TruckOwnerInfoPurchaseHistory userSeq={userSeq} carrierSeq={carrierSeq} />
                                        </div>
                                        <div className="tab-pane col-12" id="calculateHistory">
                                            <TruckOwnerInfoCalculateHistory userSeq={userSeq} carrierSeq={carrierSeq} />
                                        </div>
                                        <div className="tab-pane col-12" id="accountManagement">
                                            <TruckOwnerInfoAccountManagement userSeq={userSeq} carrierSeq={carrierSeq} />
                                        </div>
                                    </div>
                                </div>
                            </div>
