...
import CarrierAccountDetail from './CarrierAccountDetail';

function CarrierAccount({history, location, match}) {
    const CarrierAccountTbl = useRef();
    ...
    useEffect(() => {
        ...
        $("#CarrierAccountTbl").DataTable({
            ...
            ajax: {
                url: "/v1/user/accountList/ROLE_CARRIER",
                type: "GET",
                data: { length: 100 }, 
            ...
            columns : [
                ...
                { title: "운송사", data: "carrierNm", width: "20%" },
        ...
        return () => {
            ...
            $("#CarrierAccountTbl").DataTable().destroy(true);
        }
    }, []);
      ...
      <div className="card mb-4">
       ...
       <div className="card-body">
        <div className="datatable table-responsive">
         <table
          id="CarrierAccountTbl"
          ref={CarrierAccountTbl}
