...
import TruckOwnerAccountDetail from './TruckOwnerAccountDetail';

function TuckOwnerAccount({history, location, match}) {
    const TuckOwnerAccountTbl = useRef();
    ...
    useEffect(() => {
        ...
        $("#TuckOwnerAccountTbl").DataTable({
            ...
            columns : [
                { title: "no", data: null, width: "14%" },
                { title: "운송사", data: "ordersComplete", width: "14%" },
        ...
        return () => {
            ...
            $("#TuckOwnerAccountTbl").DataTable().destroy(true);
        }
    }, []);

    $(document).on("click", "tbody tr", function() {
        var userSeq = $(this).attr("id");
        var url = "/account/truckOwnerAccountDetail";
      ...
      <div className="card mb-4">
       ...
       <div className="card-body">
        <div className="datatable table-responsive">
         <table
          id="TuckOwnerAccountTbl"
          ref={TuckOwnerAccountTbl}
...
export default TuckOwnerAccount;
