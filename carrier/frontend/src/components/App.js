...
import ShippingChargesCalc from "pages/shippingChargesCalc/ShippingChargesCalc";
import ShippingChargesDetail from "pages/shippingChargesCalc/ShippingChargesDetail";
	...
	return (
		<React.Fragment>
			<Switch>
				...
				<Route exact path="/shippingChargesCalc/list" component={ShippingChargesCalc} />
				<Route exact path="/shippingChargesCalc/detail" component={ShippingChargesDetail} />
