...
function ElctrnTaxBill(props) {
	...
	const openTaxInvoice = async (values) => {
		console.log(values);
		const params = new URLSearchParams();
		params.append("mgtKey", "7a7a2bg97o2w8oei93j5d18n");
		await axios.post("/v1/barobill/getTaxInvoicePopUpURL", params).then((res) => {
			if (res.status == 200) {
				console.log(res);
				...
				<div className="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
					<div className="container-fluid">
						<div className="page-header-content">
							...
							<div className="page-header-subtitle">전자 세금계산서를 조회합니다.</div>
						</div>
					</div>
				</div>
						...
						<div className="card-header row">
							...
							<div className="col-12 row mt-3">
								...
								<div className="col-5 d-flex justify-content-center">
									<input className="form-control" id="searchWord" type="text" placeholder="like 검색창(공급자명)" />
								</div>
								<div className="form-group row col-4 d-flex justify-content-end m-auto p-auto">
									<input className="form-control datepicker col-3" id="startD" type="text" placeholder="2020-01-01" />
									<label className="col-form-label ml-3 mr-3">~</label>
									<input className="form-control datepicker col-3" id="endD" type="text" placeholder="2020-06-01" />
											...
											>
												...
												<tbody>
													<tr role="row" className="odd" data-toggle="modal" data-target="#exampleModalCenter">
														...
														<td>3,300,000</td>
														<td>
															<button className="btn btn-outline-primary shadow-sm mr-2 my-1" onClick={openTaxInvoice}>
																확인하기
															</button>
														</td>
													</tr>
													<tr role="row" className="even" data-toggle="modal" data-target="#exampleModalCenter">
														...
														<td>3,300,000</td>
														<td>
															<button className="btn btn-outline-primary shadow-sm mr-2 my-1">확인하기</button>
														</td>
													</tr>
...
export default React.memo(ElctrnTaxBill);
