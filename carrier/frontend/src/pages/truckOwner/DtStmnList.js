...
function DtStmnList(props) {
	...
	React.useEffect(() => {
		if (prevState !== undefined) {
			if (prevState.names.length !== names.length) {
				...
				<div className="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
					<div className="container-fluid">
						<div className="page-header-content">
							...
							<div className="page-header-subtitle">명세서와 이의제기 내용을 확인합니다.</div>
						</div>
					</div>
				</div>
						...
						<div className="col-lg-12">
							<div className="card">
								<div className="card-header row">
									...
									<div className="col-sm-12 col-md-6 row"></div>
								</div>
								{/*
															...
															>
																...
																<tbody>
																	<tr role="row" className="odd">
																		...
																		<td>010-1234-5678</td>
																		<td>
																			<button className="btn btn-outline-primary shadow-sm mr-2 my-1">첨부파일 등록</button>
																		</td>
																		<td>
																	...
																	<tr role="row" className="odd">
																		...
																		<td>
																			...
																			>
																				5월_명세서_김차삼.jpg
																				<button className="btn btn-outline-danger shadow-sm ml-3">X</button>
																			</button>
																		</td>
															...
															>
																...
																<tbody>
																	<tr role="row" className="odd">
																		...
																		<td>사유 제목</td>
																		<td>
																			<button class="btn btn-outline-primary shadow-sm mr-2 my-1">첨부파일 등록</button>
																			승인
																		</td>
																	</tr>
																	<tr role="row" className="even">
																	...
																	<tr role="row" className="even" data-toggle="modal" data-target="#exampleModalCenter">
																		<td className="sorting_1">TS</td>
																		<td>유아름</td>
																		<td>김차일</td>
																		<td>20.06.05</td>
																		<td>사유 제목</td>
																		<td>
																			<button class="btn btn-outline-primary shadow-sm mr-2 my-1">첨부파일 등록</button> 승인
																		</td>
																	</tr>
																	<tr role="row" className="odd" data-toggle="modal" data-target="#exampleModalCenter">
																		<td className="sorting_1">TS</td>
																		<td>유아름</td>
																		<td>김차일</td>
																		<td>20.06.05</td>
																		<td>사유 제목</td>
																		<td>
																			<button class="btn btn-outline-primary shadow-sm mr-2 my-1">첨부파일 등록</button> 반려
																		</td>
																	</tr>
																	<tr role="row" className="even" data-toggle="modal" data-target="#exampleModalCenter">
																		<td className="sorting_1">TS</td>
										...
										<div className="card-body">
											...
											<div className="card-text row">
												<dl className="col-6 row mb-auto">
													<dt className="col-4 h-25 d-flex justify-content-end">운송그룹:</dt> <dd className="col-8 h-25 ">TS</dd>
													<dt className="col-4 h-25 d-flex justify-content-end">요청일:</dt> <dd className="col-8 h-25 ">20.06.05</dd>
												</dl>
												<dl className="col-6 row mb-auto">
													<dt className="col-5 h-25 d-flex justify-content-end">매니저코드:</dt> <dd className="col-7 h-25 ">TS_0002</dd>
													<dt className="col-5 h-25 d-flex justify-content-end">담당자:</dt> <dd className="col-7 h-25 ">유아름</dd>
												</dl>
												<dl className="col-12 m-auto pt-5">
													<dt className="mb-3">요청 사유</dt>
													<dd> 무단 결근 한 적이 없는데, 무단 결근처리 되서 패널티가 적용되었습니다 .</dd>
												</dl>
											</div>
										</div>
									</div>
...
export default React.memo(DtStmnList);
