...
function OrderManageItem(props) {
	const { obj, tabType, getCarrierOrders } = props;
	if (obj.status == "0702") {
		console.log(obj);
	}
	const modalClickUpdate = (obj, tabType) => {
		console.log("#updateModalPopup" + obj.orderSeq + tabType);
		$("#updateModalPopup" + obj.orderSeq + tabType).modal("hide");
	};

	const modalClickComplete = (obj, tabType) => {
	...
	const modalClickDelete = (obj, tabType) => {
	...
	return (
		<tr style={{ display: props.display }} className="col-12">
			<td className="col-12">
						...
						<div className="modal-content">
							...
							<div className="modal-footer">
								...
								<Link
									...
									onClick={() => modalClickUpdate(obj, tabType)}
								>
									네
								</Link>
							</div>
					...
					<div className="modal-dialog modal-dialog-centered" role="document">
						<div className="modal-content">
							...
							<div className="modal-footer">
								...
								<button type="button" className="btn btn-secondary" onClick={() => modalClickComplete(obj, tabType)}>
									네
								</button>
							</div>
						</div>
					...
					<div className="modal-dialog modal-dialog-centered" role="document">
						<div className="modal-content">
							...
							<div className="modal-footer">
								...
								<button type="button" className="btn btn-secondary" onClick={() => modalClickDelete(obj, tabType)}>
									네
								</button>
							</div>
						</div>
