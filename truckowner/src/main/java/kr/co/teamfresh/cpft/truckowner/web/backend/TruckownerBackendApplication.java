package kr.co.teamfresh.cpft.truckowner.web.backend;
...
public class TruckownerBackendApplication {

	public static void main(String[] args) {
		SpringApplication.run(TruckownerBackendApplication.class, args);
	}
